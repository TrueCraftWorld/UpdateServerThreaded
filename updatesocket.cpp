    ...
    : QTcpSocket{parent}, socketID(ID)
{
    ...
    connect(this,&UpdateSocket::bytesWritten,this,&UpdateSocket::receiveData);
    // connect(this, &UpdateSocket::bytesWritten, this, [this](int bytes){
    //     qDebug() << bytes << '\n';
